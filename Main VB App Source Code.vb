...
Public Class aircraftPage
    ...
    'if not done already, paste the "airfieldsDATA.csv" CSV into the /bin/debug folder of the solution's files to use debugging, or just run the executeable if antivirus permits it...
